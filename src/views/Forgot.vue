  ...
  <div class="login">
    ...
    <div class="user-box">
      ...
      <van-form v-show="!isNext">
        ...
        >
           <template #button>
            <van-button size="small" color="#9c6632" :disabled="isSend" @click="getValidCode">{{text}}</van-button>
          </template>
        </van-field>
        <div class="forgot">
        ...
        <div class="commit-btn">
          <van-button @click="next" round block color="#9c6632">
            下一步
          </van-button>
        </div>
      </van-form>
      ...
      <van-form v-show="isNext">
        ...
        <div class="commit-btn">
          <van-button round block color="#9c6632" @click="commit">
            提交
          </van-button>
        </div>
        <div class="commit-btn">
