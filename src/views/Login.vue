    ...
    <div class="user-box">
      ...
      <van-form>
        ...
        <div class="commit-btn">
          <van-button round block color="#9c6632" @click="login">
            立即登录
          </van-button>
        </div>
        ...
        <div class="commit-handle">
          ...
          <span class="commit-btn" @click="toggleRegisterBox">
            立即注册
          </span>
        </div>
      </van-form>
    ...
    >
      ...
      <van-form>
        ...
        <div class="commit-btn register-btn">
          <van-button round block color="#9c6632" @click="register">
            注册
          </van-button>
        </div>
      </van-form>
